...
## Using uDoctor - Flatiron Module 1 Final Project
...
uDoctor is an app created by Kevin Bagnall (github) and Richard Pitts (github).
Made with Love at Flatiron, the app is designed to help users find the doctor they need.
It is coded using Ruby while employing a live API integarted with SQLite3 database technology.

### MVP allowing the user to:

1. Create user profile that will save user's searches.
2. Search for doctors by region/location
3. Search by doctor specialty 
4. Search for a patients doctors visited
5. Search for the number of reviews written by a patient

### Stretch Goals

In order to add more depth to our app, we wanted to:

1. Decorate throughout making it as aesthetic as possible.  
2. Add more features:
2.A. Search for doctors above a certain rating in a certain region
2.B. Search for the best doctor in a certain region
2.C. Return a list of the best doctors by practice

### API Details

[https://developer.betterdoctor.com]( c7e71f6a64fb691e184217eb875a38c3
...
Here is where we would show JPG/PNG's of the app with the different menu sections